...
if($vsnmp == 1) {
	$quantidade = sanitizeString(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2011.6.128.1.1.2.21.1.16.{$valor}", 1000000, 30));
}else if($vsnmp == 2) {
	$quantidade = sanitizeString(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2011.6.128.1.1.2.21.1.16.{$valor}", 1000000, 30));
}else if($vsnmp == 3) {
	$quantidade = sanitizeString(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.2011.6.128.1.1.2.21.1.16.{$valor}", 1000000, 30));
}
