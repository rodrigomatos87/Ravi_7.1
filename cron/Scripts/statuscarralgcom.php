...
if($vsnmp == 1) {
	$status = str_replace('INTEGER: ', '', (snmpget("{$ip}:{$porta}", $comunidade, "1.3.6.1.4.1.49136.1.2.3.0", 1000000, 30)));
}else if($vsnmp == 2) {
	$status = str_replace('INTEGER: ', '', (snmp2_get("{$ip}:{$porta}", $comunidade, "1.3.6.1.4.1.49136.1.2.3.0", 1000000, 30)));
}else if($vsnmp == 3) {
	$status = str_replace('INTEGER: ', '', (snmp3_get("{$ip}:{$porta}", $comunidade, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.49136.1.2.3.0", 1000000, 30)));
}
