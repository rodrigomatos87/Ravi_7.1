...
if($vsnmp == 1) {
	$noisefloor = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.41112.1.4.5.1.8.1", 1000000, 30));
}else if($vsnmp == 2) {
	$noisefloor = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.41112.1.4.5.1.8.1", 1000000, 30));
}else if($vsnmp == 3) {
	$noisefloor = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.41112.1.4.5.1.8.1", 1000000, 30));
}
