...
if($vsnmp == 1) {
	$temperatura = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.3902.1015.2.1.3.13.5.1.1.1.1.{$valor}", 1000000, 30));
}else if($vsnmp == 2) {
	$temperatura = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.3902.1015.2.1.3.13.5.1.1.1.1.{$valor}", 1000000, 30));
}else if($vsnmp == 3) {
	$temperatura = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.3902.1015.2.1.3.13.5.1.1.1.1.{$valor}", 1000000, 30));
}
