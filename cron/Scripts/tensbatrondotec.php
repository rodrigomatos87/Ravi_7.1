...
if($vsnmp == 1) {
    $voltagem = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.36582.5.1.0", 1000000, 30));
}else if($vsnmp == 2) {
    $voltagem = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.36582.5.1.0", 1000000, 30));
}else if($vsnmp == 3) {
	$voltagem = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.36582.5.1.0", 1000000, 30));
}
