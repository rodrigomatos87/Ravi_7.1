...
if($vsnmp == 1) {
	$voltagem = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2281.10.1.1.10.0", 1000000, 30));
}else if($vsnmp == 2) {
	$voltagem = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2281.10.1.1.10.0", 1000000, 30));
}else if($vsnmp == 3) {
	$voltagem = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.2281.10.1.1.10.0", 1000000, 30));
}
...
if(isset($voltagem) && $voltagem != "") {
	if(isset($valor) && $valor != "" && $valor != "NULL") {
		...
		}else if(isset($media1) && $media1 != "" && $media1 != "NULL" && isset($maxPer) && $maxPer != "") {
