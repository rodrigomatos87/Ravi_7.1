...
if($vsnmp == 1) {
	$quantidade = count(array_filter(snmpwalk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.37950.1.1.5.12.1.25.1.5.{$valor}", 1000000, 30)));
}else if($vsnmp == 2) {
	$quantidade = count(array_filter(snmp2_walk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.37950.1.1.5.12.1.25.1.5.{$valor}", 1000000, 30)));
}else if($vsnmp == 3) {
	$quantidade = count(array_filter(snmp3_walk("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.37950.1.1.5.12.1.25.1.5.{$valor}", 1000000, 30)));
}
