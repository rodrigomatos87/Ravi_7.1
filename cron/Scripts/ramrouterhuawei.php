...
if($vsnmp == 1) {
    $totaR = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2011.6.3.5.1.1.2.0.0.0", 1000000, 30));
}else if($vsnmp == 2) {
    $totaR = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2011.6.3.5.1.1.2.0.0.0", 1000000, 30));
}else if($vsnmp == 3) {
	$totaR = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.2011.6.3.5.1.1.2.0.0.0", 1000000, 30));
}

if($totaR) {
	$StErro = 1;
	if($vsnmp == 1) {
		$livreR = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2011.6.3.5.1.1.3.0.0.0", 1000000, 30));
	}else if($vsnmp == 2) {
		$livreR = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2011.6.3.5.1.1.3.0.0.0", 1000000, 30));
	}else if($vsnmp == 3) {
		$livreR = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.2011.6.3.5.1.1.3.0.0.0", 1000000, 30));
	}
