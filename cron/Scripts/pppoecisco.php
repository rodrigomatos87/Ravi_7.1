...
if($vsnmp == 1) {
	$ServPPPoE = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.9.9.194.1.1.1.0", 1000000, 30));
}else if($vsnmp == 2) {
	$ServPPPoE = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.9.9.194.1.1.1.0", 1000000, 30));
}else if($vsnmp == 3) {
	$ServPPPoE = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.9.9.194.1.1.1.0", 1000000, 30));
}
