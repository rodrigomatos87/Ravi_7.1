...
if($vsnmp == 1) {
	$status = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.9.9.117.1.4.1.1.1.{$valor}", 1000000, 30));
}else if($vsnmp == 2) {
	$status = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.9.9.117.1.4.1.1.1.{$valor}", 1000000, 30));
}else if($vsnmp == 3) {
	$status = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.9.9.117.1.4.1.1.1.{$valor}", 1000000, 30));
}
