...
if($vsnmp == 1) {
    $corrente = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.17095.1.3.4.0", 3000000, 30));
}else if($vsnmp == 2) {
    $corrente = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.17095.1.3.4.0", 3000000, 30));
}else if($vsnmp == 3) {
	$corrente = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.17095.1.3.4.0", 1000000, 30));
}
