...
if($vsnmp == 1) {
    $temperatura = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.37950.1.1.5.10.12.5.9.0", 1000000, 30));
}else if($vsnmp == 2) {
    $temperatura = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.37950.1.1.5.10.12.5.9.0", 1000000, 30));
}else if($vsnmp == 3) {
	$temperatura = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.37950.1.1.5.10.12.5.9.0", 1000000, 30));
}
