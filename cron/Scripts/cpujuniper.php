...
if($vsnmp == 1) {
    $cpu = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2636.3.1.13.1.8.9.1.0.0", 1000000, 30));
}else if($vsnmp == 2) {
    $cpu = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2636.3.1.13.1.8.9.1.0.0", 1000000, 30));
}else if($vsnmp == 3) {
	$cpu = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.2636.3.1.13.1.8.9.1.0.0", 1000000, 30));
}
