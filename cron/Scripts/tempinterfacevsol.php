...
if($vsnmp == 1) {
	$temperatura = sanitizeString(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.37950.1.1.5.10.13.1.1.2.{$valor}", 1000000, 30));
}else if($vsnmp == 2) {
	$temperatura = sanitizeString(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.37950.1.1.5.10.13.1.1.2.{$valor}", 1000000, 30));
}else if($vsnmp == 3) {
	$temperatura = sanitizeString(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.37950.1.1.5.10.13.1.1.2.{$valor}", 1000000, 30));
}
