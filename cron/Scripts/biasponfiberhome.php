...
if($vsnmp == 1) {
	$bias = sanitizeString(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.5875.800.3.9.3.4.1.10.{$valor}", 1000000, 30));
}else if($vsnmp == 2) {
	$bias = sanitizeString(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.5875.800.3.9.3.4.1.10.{$valor}", 1000000, 30));
}else if($vsnmp == 3) {
	$bias = sanitizeString(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.5875.800.3.9.3.4.1.10.{$valor}", 1000000, 30));
}
