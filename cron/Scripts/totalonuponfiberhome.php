...
if($vsnmp == 1) {
	$quantidade = array_sum(sanitizeSNMP(snmpwalk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.5875.800.3.9.3.4.1.12", 1000000, 30)));
}else if($vsnmp == 2) {
    $quantidade = array_sum(sanitizeSNMP(snmp2_walk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.5875.800.3.9.3.4.1.12", 1000000, 30)));
}else if($vsnmp == 3) {
	$quantidade = array_sum(sanitizeSNMP(snmp3_walk("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.5875.800.3.9.3.4.1.12", 1000000, 30)));
}
