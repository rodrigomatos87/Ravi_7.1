...
if($vsnmp == 1) {
	$power = casas(snmpget("{$ip}:{$porta}", $snmp, ".1.3.6.1.4.1.2011.5.25.31.1.1.3.1.32." . $valor, 1000000, 30));
}else if($vsnmp == 2) {
	$power = casas(snmp2_get("{$ip}:{$porta}", $snmp, ".1.3.6.1.4.1.2011.5.25.31.1.1.3.1.32." . $valor, 1000000, 30));
}else if($vsnmp == 3) {
	$power = casas(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, ".1.3.6.1.4.1.2011.5.25.31.1.1.3.1.32." . $valor, 1000000, 30));
}
