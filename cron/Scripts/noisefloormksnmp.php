...
if($vsnmp == 1) {
	$buscanoisefloor = snmpwalk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.14988.1.1.1.3.1.9", 1000000, 30);
}else if($vsnmp == 2) {
	$buscanoisefloor = snmp2_walk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.14988.1.1.1.3.1.9", 1000000, 30);
}else if($vsnmp == 3) {
	$buscanoisefloor = snmp3_walk("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.14988.1.1.1.3.1.9", 1000000, 30);
}
$noisefloor = sanitizeSNMP($buscanoisefloor[0]);
