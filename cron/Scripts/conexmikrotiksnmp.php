...
if($vsnmp == 1) {
	$conexoestest = snmpwalk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.14988.1.1.1.3.1.6", 1000000, 30);
}else if($vsnmp == 2) {
	$conexoestest = snmp2_walk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.14988.1.1.1.3.1.6", 1000000, 30);
}else if($vsnmp == 3) {
	$conexoestest = snmp3_walk("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.14988.1.1.1.3.1.6", 1000000, 30);
}

$conexoes = sanitizeSNMP($conexoestest[0]);
