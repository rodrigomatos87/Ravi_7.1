...
if($vsnmp == 1) {
	$tx = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.41112.1.4.5.1.9.1", 1000000, 30));
    $rx = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.41112.1.4.5.1.10.1", 1000000, 30));
}else if($vsnmp == 2) {
	$tx = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.41112.1.4.5.1.9.1", 1000000, 30));
    $rx = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.41112.1.4.5.1.10.1", 1000000, 30));
}else if($vsnmp == 3) {
	$tx = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.41112.1.4.5.1.9.1", 1000000, 30));
	$rx = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.41112.1.4.5.1.10.1", 1000000, 30));
}
