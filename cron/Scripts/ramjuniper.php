...
if($vsnmp == 1) {
    $ram = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2636.3.1.13.1.11.9.1.0.0", 1000000, 30));
}else if($vsnmp == 2) {
    $ram = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.2636.3.1.13.1.11.9.1.0.0", 1000000, 30));
}else if($vsnmp == 3) {
	$ram = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.2636.3.1.13.1.11.9.1.0.0", 1000000, 30));
}
