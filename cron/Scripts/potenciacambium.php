...
if($vsnmp == 1) {
    $power = sanitizeSNMP(snmpget("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.17713.21.1.2.5.0", 1000000, 30));
}else if($vsnmp == 2) {
    $power = sanitizeSNMP(snmp2_get("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.17713.21.1.2.5.0", 1000000, 30));
}else if($vsnmp == 3) {
	$power = sanitizeSNMP(snmp3_get("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.17713.21.1.2.5.0", 1000000, 30));
}
