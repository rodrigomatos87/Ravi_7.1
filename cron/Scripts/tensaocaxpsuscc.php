...
if($vsnmp == 1) {
	$buscastatus = snmpwalk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.34252.1.1.43.7", 1000000, 30);
}else if($vsnmp == 2) {
	$buscastatus = snmp2_walk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.34252.1.1.43.7", 1000000, 30);
}else if($vsnmp == 3) {
	$buscastatus = snmp3_walk("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.34252.1.1.43.7", 1000000, 30);
}
