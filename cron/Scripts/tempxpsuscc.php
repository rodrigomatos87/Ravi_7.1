...
if($vsnmp == 1) {
	$buscatemperatura = snmpwalk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.34252.1.1.38", 1000000, 30);
}else if($vsnmp == 2) {
	$buscatemperatura = snmp2_walk("{$ip}:{$porta}", $snmp, "1.3.6.1.4.1.34252.1.1.38", 1000000, 30);
}else if($vsnmp == 3) {
	$buscatemperatura = snmp3_walk("{$ip}:{$porta}", $snmp, $nivelsegsnmp, $protocoloauthsnmp, $authsnmp, $protocolocripsnmp, $criptosnmp, "1.3.6.1.4.1.34252.1.1.38", 1000000, 30);
}

$temperatura = sanitizeSNMP($buscatemperatura[0]);
